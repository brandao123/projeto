...
<?php 
	...
	require_once "functions/cartroupa.php";
	...
	if(isset($_GET['acao']) && in_array($_GET['acao'], array('add', 'del', 'up'))) {
		...
		header('location: carrinhoroupa.php');
	}
	...
	<div class="container">
		<div class="card mt-5">
			 <div class="card-body">
	    		...
	    		<a class="btn btn-outline-dark" href="roupas.php">Lista de Produtos</a>
	    	</div>
		</div>

		<?php if($resultsCarts) : ?>
			<form action="carrinhoroupa.php?acao=up" method="post">
				...
				<tbody>
				  <?php foreach($resultsCarts as $result) : ?>
					<tr>
						...
						<td><a href="carrinho.php?acao=del&id=<?php echo $result['id']?>" class="btn btn-outline-danger">Remover</a></td>
			...
			<a class="btn btn-outline-dark" href="roupas.php">Continuar Comprando</a>
