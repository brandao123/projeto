...
<?php 
	...
	require_once "functions/cartjogo.php";
	...
	if(isset($_GET['acao']) && in_array($_GET['acao'], array('add', 'del', 'up'))) {
		...
		header('location: carrinhojogo.php');
	}
	...
	<div class="container">
		<div class="card mt-5">
			 <div class="card-body">
	    		...
	    		<a class="btn btn-outline-dark" href="jogos.php">Lista de Produtos</a>
	    	</div>
		</div>

		<?php if($resultsCarts) : ?>
			<form action="carrinhojogo.php?acao=up" method="post">
			...
			<a class="btn btn-outline-dark" href="jogos.php">Continuar Comprando</a>
