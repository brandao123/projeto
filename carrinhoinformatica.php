...
<?php 
	...
	require_once "functions/cartinformatica.php";
	...
	if(isset($_GET['acao']) && in_array($_GET['acao'], array('add', 'del', 'up'))) {
		...
		header('location: carrinhoinformatica.php'); 
	}
...
<body>
	...
	<div class="container">
		...
		<?php if($resultsCarts) : ?>
			<form action="carrinhoinformatica.php?acao=up" method="post">
				...
				<tbody>
				  <?php foreach($resultsCarts as $result) : ?>
					<tr>
						...
						<td><a href="carrinhoinformatica.php?acao=del&id=<?php echo $result['id']?>" class="btn btn-outline-danger">Remover</a></td>
