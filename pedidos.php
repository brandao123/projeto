...
<?php 
 	session_start();
	require_once "functions/productpedido.php";
	require_once "functions/cartpedido.php";
	...
	if(isset($_GET['acao']) && in_array($_GET['acao'], array('add', 'del', 'up'))) {
		...
		header('location: carrinhopedido.php');
	}
	...
	<div class="container">
		<div class="card mt-5">
			 <div class="card-body">
	    		...
	    		<a class="btn btn-outline-dark" href="pedidos.php">Lista de Pedidos</a>
	    	</div>
		</div>

		<?php if($resultsCarts) : ?>
			<form action="cpedido.php?acao=up" method="post">
				...
				<tbody>
				  <?php foreach($resultsCarts as $result) : ?>
					<tr>
						...
						<td><a href="carrinhopedido.php?acao=del&id=<?php echo $result['id']?>" class="btn btn-outline-danger">Remover</a></td>
			...
			<a class="btn btn-outline-dark" href="pedido.php">Continuar Comprando</a>
